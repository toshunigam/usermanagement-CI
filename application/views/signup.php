...
<head>
	...
	<!-- waves css -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/bower_components/Waves/css/waves.min.css">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<div class="login-card card-block m-auto">
					<form class="md-float-material" action="<?php echo site_url('index.php/signup/login'); ?>" method="post">
						...
						<div class="row">
							...
							<div class="rkmd-checkbox checkbox-rotate checkbox-ripple m-b-25">
								<label class="input-checkbox checkbox-primary">
									<input type="checkbox" id="checkbox" name="driver" value="driver">
									<span class="checkbox"></span>
								</label>
								<div class="captions">Login as a driver</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<input type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">LOGIN</button>
							</div>
						</div>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/common-pages.min.js"></script>
